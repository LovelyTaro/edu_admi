...
<div class="layout_left_menu">
    <ul id="menu">
        <!--首页-->
        <li class="childUlLi">
            <a href="tea_home.jsp"> <i class="glyph-icon icon-reorder"></i>个人信息</a>
            <ul>
            </ul>
        </li>
        <!--成员管理-->
        <li class="childUlLi">
            <a href="TeacherCoursesServlet"> <i class="glyph-icon icon-reorder"></i>查看课表</a>
            <ul>
            </ul>
        </li>
        <!--角色管理-->
...
<div id="layout_right_content" class="layout_right_content">
    ...
    <div class="route_bg" id="content_index">
        ...
        <a>选课</a><i class="glyph-icon icon-chevron-right"></i>
    </div>
    <!--右边主体部分的索引结束-->
    <!--右边主体部分的内容-->
    <div class="main_content">
        ...
        <div id="courseManagement" class="page_content">
            <div class="container-fluid">
                <div class="row" style="width: 100%;height: 10%;">
                    <div class=".col-md-6"
                        ...
                        <div class="page-header">
                            <h1>我的课程 <small>My Courses</small></h1>
                        </div>
                    </div>
                </div>
                                ...
                                <c:forEach var="course" items="${courseList}" begin="0" end="${courseList.size()}" step="1">
                                    <c:if test="${course.courseNum != 0}">
                                        <tr>
                                            ...
                                            <button class="btn btn-default" data-courseNum="${course.courseNum}" data-courseName="${course.courseName}" onclick="selectButton(this)">打分
                                            </button>
                                        </td>
                                        </tr>
                                    </c:if>
                ...
                <div class="row" style="height: 10%; margin-bottom: 20px">
                    <!--分页-用来翻页-->
                    <div class="nav_outside">
                        <nav aria-label="...">
                            <ul class="pager">
                                <li><a href="javascript:pageForwardMyCourse();">向前</a></li>
...
<%--                                ${page}--%>
                                ...
                                <li><a href="javascript:pageBackwardMyCourse();">向后</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
...
<script>
    function selectButton(e) {
        window.location.href = "ScoreServlet?courseNum=" + e.getAttribute("data-courseNum")+"&courseName="+ e.getAttribute("data-courseName");
    }
</script>