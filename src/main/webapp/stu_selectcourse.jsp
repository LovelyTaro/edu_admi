            ...
            <div class="container-fluid">
                <div class="row" style="width: 100%;height: 10%;">
                    <div class=".col-md-6"
                        ...
                        <div class="page-header">
                            <h1>选课系统 <small>Course Selection System</small></h1>
                        </div>
                    </div>
                </div>
                                ...
                                <c:forEach var="course" items="${courseList}" begin="0" end="${courseList.size()}" step="1">
                                    <c:if test="${course.courseNum != 0}">
                                        <tr>
                                            ...
                                            <button class="btn btn-default" id="select" data-courseNum="${course.courseNum}" onclick="selectButton(this)">选课</button>
                                        </td>
                                        </tr>
                                    </c:if>
                                </c:forEach>
                ...
                <div class="row" style="height: 10%;">
                    ...
                    <div class="nav_outside">
                        <nav aria-label="...">
                            <ul class="pager">
                                <li><a href="javascript:pageForwardSelectCourse();">向前</a></li>
...
<%--                                ${page}--%>
                                ...
                                <li><a href="javascript:pageBackwardSelectCourse();">向后</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
...
<script>
    function selectButton(e) {
        window.location.href = "SelectCourseServlet?page=${page}&select=" + e.getAttribute("data-courseNum");
    }
</script>